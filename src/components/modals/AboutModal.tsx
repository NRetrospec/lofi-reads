      ...
      <DialogContent className="max-w-5xl w-[95vw] max-h-[90vh] overflow-y-auto p-0">
        <div className="p-6 md:p-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                ...
                {/* Decorative elements */}
                <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-full bg-accent/10 -z-10" />
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-3 text-foreground/80 leading-relaxed mb-6 text-sm">
                <p>
              ...
              <div className="grid grid-cols-3 gap-3 py-4 border-y border-border mb-6">
                <div className="text-center">
                  <p className="font-serif text-2xl text-primary mb-1">6</p>
                  <p className="text-xs uppercase tracking-wider text-muted-foreground">Books</p>
                </div>
                <div className="text-center">
                  <p className="font-serif text-2xl text-primary mb-1">12</p>
                  <p className="text-xs uppercase tracking-wider text-muted-foreground">Awards</p>
                </div>
                <div className="text-center">
                  <p className="font-serif text-2xl text-primary mb-1">1M+</p>
          ...
          <div className="mt-10 text-center border-t border-border pt-8">
            ...
            <p className="mt-4 text-muted-foreground text-sm">— Elena Nightingale</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
